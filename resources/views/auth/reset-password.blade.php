    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                @if (session('status'))
                <div class="text-success border-start border-3 border-success bg-success-subtle p-2 mb-2">
                    {{ session('status') }}
                </div>
                @endif
                <form action="{{ route('password.update') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="d-grid gap-2"> <button type="submit" class="btn btn-primary">Salvar</button> </div>
                        </div> <!-- /.col -->
                    </div> <!--end::Row-->
                </form>
